        ...
        <>
            ...
            <div className="container policies">
                ...
                <p> -Medsys grants you permission to view this site and to print individual pages from this site for your
                    ...
                    prior written approval from the Medsys. You represent and warrant to the Company that you will not use
                    this site for any purpose that is unlawful, immoral or prohibited by these terms, conditions, and
                    notices. If you do not agree and accept without modification the notices, terms, and conditions set
                    forth herein, do not use this site. Other than this agreement and any other written agreements between
                    you and the Medsys.
                </p>
                <p>Medsys will not enter into any agreement with you or obligation to you through this site and no attempt
                    to create such an agreement or obligation will be effective.
                </p>
                <p>-The content provided is for information purposes alone and does not substitute for specific advice
                ...
                <p>-You agree that you will not upload, post, share, or otherwise distribute any content on our web public
                    space which is illegal, threatening, defamatory, abusive, harassing, defame, degrading, intimidating,
                    fraudulent, deceptive, invasive, racist, or contains any type of suggestive, inappropriate, or explicit
                    language, contains any type of unauthorized or unsolicited advertising;
                </p>
                <p>-We have the right at our sole discretion to remove any content that, we feel in our judgment does not
                    comply with these terms & conditions, along with any content that we feel is otherwise offensive,
                ...
                <p>YOU AGREE TO INDEMNIFY, DEFEND AND HOLD HARMLESS THIS WEBSITE INCLUDING BUT NOT LIMITED TO ITS PARENT
                    COMPANY/LLP, PARTNERS, OWNERS, AFFILIATE VENDORS, AGENTS AND EMPLOYEES FROM AND AGAINST ANY AND ALL
                    LOSSES, LIABILITIES, CLAIMS, DAMAGES, DEMANDS, COSTS AND EXPENSES (INCLUDING LEGAL FEES AND
                    DISBURSEMENTS IN CONNECTION THEREWITH AND INTEREST CHARGEABLE THEREON) ASSERTED AGAINST OR INCURRED BY
                    US THAT ARISE OUT OF, RESULT FROM, OR MAY BE PAYABLE BY VIRTUE OF, ANY BREACH OR NON-PERFORMANCE OF ANY
                    REPRESENTATION, WARRANTY, COVENANT OR AGREEMENT MADE OR OBLIGATION TO BE PERFORMED BY YOU / US PURSUANT
                    TO THESE TERMS OF USE. FURTHER, YOU AGREE TO HOLD US HARMLESS AGAINST ANY CLAIMS MADE BY ANY THIRD PARTY
                    DUE TO, OR ARISING OUT OF, OR IN CONNECTION WITH, YOUR USE OF THE WEBSITE, ANY CLAIM THAT YOUR MATERIAL
                ...
                <h2>TERMINATION OF USE
                </h2>
                <p>You agree that we may, at our sole discretion, reserve the rights to suspend or terminate your access to
                    all or part of our website and resources with or without notice and for any reason, including, without
                    limitation, breach of these terms & conditions and to take all necessary measures to prevent access to
                    any services or termination of services if the terms are not complied with or are contravene or
                    violation suspected.
                </p>
                <h2>DATA PROVIDED BY US
                </h2>
                <p>1.From time to time, our team may post comments or articles. These articles are the Intellectual Property
                    of the Company and you are prohibited from posting, reproducing, publishing, changing, or editing such
                    articles. In case you have a problem with any article so posted, you may report the same via mail and we
                ...
                <p>3.We are not in any way liable to You, for any loss arising to you from activities that include but are
                    not limited to our negligence, breach of contract, Intellectual Property and Trademark infringement,
                    breach of laws, etc.
                </p>
                <p>4. From time to time, our website with has external links connected to other websites. We in no way
                ...
                <h2>THIRD PARTY INFORMATION
                </h2>
                <p>All text, graphics, user interfaces, visual interfaces, photographs, trademarks, logos, sounds, music and
                    artwork (collectively, "Content"), apart from the ones owned by Us, is a third-party user generated
                    content and We have no control over such third-party user generated content.
                </p>
                <p>Other than when provided for, the use of such content and it being reproduced, republished, uploaded,
                    posted, publicly displayed, encoded, translated, transmitted or distributed in any way (including
                    "mirroring") to any other computer, server, Website or another medium for publication or distribution or
                    for any commercial enterprise, without Our express prior written consent is not allowed.br <br /> <br />
                </p>
                ...
                <p>This Agreement, the construction, enforcement and the interpretation of its terms and any disputes
